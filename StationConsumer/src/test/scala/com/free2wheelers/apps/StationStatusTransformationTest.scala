...
class StationStatusTransformationTest extends FeatureSpec with Matchers with GivenWhenThen {
  ...
  feature("Apply transformations to data frame") {
    ...
    scenario("Transform station_status data frame and extract useful fields of NYC") {
      ...
      val resultDF1 = statusInformationJson2DF(testDF1, spark)
      ...
      resultDF1.schema.fields(2).name should be("is_rending")
    ...
    scenario("Transform status information data frame and extract useful fields of SF") {
      ...
      When("Transformations are applied")
      val resultDF2 = statusInformationJson2DF(testDF2, spark)

      Then("Useful columns are extracted")
      resultDF2.schema.fields(0).name should be("bike_available")
      ...
      resultDF2.schema.fields(2).name should be("is_rending")
      ...
      row1.get(3) shouldBe true
      row1.get(4) should be(1535551168)
      ...
      row2.get(4) should be(1535551321)
