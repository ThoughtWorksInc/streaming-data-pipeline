...
nohup java -jar /tmp/free2wheelers-citibike-apis-producer0.1.0.jar --spring.profiles.active=${station_nyc} --producer.topic=station_data_nyc --kafka.brokers=kafka.twdu1.training:9092 1>/tmp/${station_nyc}.log 2>/tmp/${station_nyc}.error.log &
